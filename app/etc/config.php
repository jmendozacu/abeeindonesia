...
return [
    'modules' => [
        ...
        'Meigee_ThemeActivator' => 1,
        'Meigee_FacebookLikeBox' => 1,
        'Meigee_Instagram' => 1,
        'Meigee_Popup' => 1,
        'Meigee_Sirena' => 1,
        'Meigee_BackgroundSlider' => 1,
        ...
        'Midtrans_Snapspec' => 0,
        'Sams_Address' => 1,
        'Sams_CustomShipping' => 1,
        'Sams_RajaongkirJnt' => 1,
        'Sams_RajaongkirPos' => 1,
        'Sams_RajaongkirTiki' => 1,
        'Temando_Shipping' => 1,
        'Vertex_Tax' => 1,
        'WeltPixel_Backend' => 1,
